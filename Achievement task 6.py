print("\n***Welcome to Prime and Non-Prime List***\n")
...
List = [int(num) for num in input("Please enter an integer\n").split(',')]
...
for number in List: #Iterate over the list
    ...
    for a in range(1,number):  #Iterate from 1 to given number
        if number%a ==0: #If number is divisible by other than 1 and itself
...
print("\nBelow listed are prime numbers:")
print(*Prime_List, sep = ", ") #print the Prime_List numbers by comma-separated
print("\n\n") #for space
print("Below listed are non-prime numbers:")
